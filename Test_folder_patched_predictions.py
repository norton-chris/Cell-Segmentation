...
# {code}
################################# EDIT THE LINE BELOW ###############################
test = "/home/chris/Downloads/561/" #"TrainingDataset/data_subset/output/test/" ## EDIT THIS LINE
...
showImage = False  # select this is you want to preview each image
################################# EDIT THE LINE ABOVE ###############################
...
for path in os.listdir(test):  # Loop over Images in Directory
    ...
    try:
        ...
        print("error on Patcher.. skipping image..", e)
        continue
    ...
    cv2.imwrite("inference/predictions/video/" + path, full_pred_image)
